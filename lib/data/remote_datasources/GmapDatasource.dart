...
class GmapDatasource {
  ...
  Future<Either<String, GmapModel>> getCurrentPosition() async {
    try {
      ...
      return Right(GmapModel(latLng: latLng, address: address));
    } on PlatformException catch (e) {
      if (e.code == 'IO_ERROR') {
        debugPrint(
            'A network error occurred trying to lookup the spplied coordinats : ${e.message}');
      }
